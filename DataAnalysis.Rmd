...
prot_adjustment <- (as.matrix(flowseq_counts[, 3:14], na.rm = TRUE) %*% diag(bin_pcts202 / flowseq.sums))  / 
  sum((as.matrix(flowseq_counts[, 3:14], na.rm = TRUE) %*% diag(bin_pcts202 / flowseq.sums)), na.rm = TRUE)
```
